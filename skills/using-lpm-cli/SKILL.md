...
| Add / remove / upgrade dependencies | [install](https://cli.lpm.dev/docs/packages/install.mdx) · [uninstall](https://cli.lpm.dev/docs/packages/uninstall.mdx) · [upgrade](https://cli.lpm.dev/docs/packages/upgrade.mdx) · [outdated](https://cli.lpm.dev/docs/packages/outdated.mdx) |
...
- **Both lockfiles are committed:** `lpm.lock` (TOML, diffable) and `lpm.lockb` (binary). Never gitignore either.

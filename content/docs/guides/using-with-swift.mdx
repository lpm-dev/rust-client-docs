...
If an older CLI created package references that Xcode ignored, repeat the install with the updated CLI. It repairs those misplaced references. If Xcode is open, close and reopen the project after installation.

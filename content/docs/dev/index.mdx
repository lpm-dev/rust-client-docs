...
<Cards>
  ...
  <Card title="Using LPM Vault" href="/docs/dev/lpm-vault" description="Store project secrets in the macOS app and load them into your application with LPM CLI." />
</Cards>

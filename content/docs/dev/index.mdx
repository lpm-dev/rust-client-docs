...
<Cards>
  ...
  <Card title="Local secrets" href="/docs/dev/lpm-vault" description="Store project secrets outside your repository and load them into applications with LPM CLI." />
</Cards>

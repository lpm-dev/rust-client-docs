...
## Lint, format, type-check, bundle (built-in tools)
...
<Cards>
  ...
  <Card title="lpm bundle" href="/docs/dev/bundle" description="Backed by a managed Rolldown engine with a verified cached package layout." />
...
<Cards>
  ...
  <Card title="Built-in tools" href="/docs/dev/builtin-tools" description="How Oxlint and Biome ship, and how managed engines power tsgo and Rolldown." />

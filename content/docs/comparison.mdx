...
| [Minimum release age (cooldown)](/docs/packages/install#recently-published-packages)                                 | `min-release-age` flag, off by default | 1-day cooldown by default                                   | Off by default                                                                 | 1-day direct/root cooldown by default                                                                                                                                               |

...
| Catalog version pins for monorepos (one declaration, every member references it)             | —                      | `pnpm-workspace.yaml > catalog` | Catalogs in lockfile              | `package.json > catalogs`, plus pnpm-style `pnpm-workspace.yaml` catalogs                                         |

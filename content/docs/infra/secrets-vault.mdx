...
On macOS, the [LPM Vault app](/docs/dev/lpm-vault) shares local Keychain storage with LPM CLI. Both use the project's `vault` ID in `lpm.json`.
...
- [Using LPM Vault](/docs/dev/lpm-vault) — connect the macOS app to your development workflow

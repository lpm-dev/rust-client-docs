...
The project's `vault` ID in `lpm.json` associates it with [local secrets](/docs/dev/lpm-vault). No desktop app is required.
...
- [Local secrets](/docs/dev/lpm-vault) — load protected values into your application

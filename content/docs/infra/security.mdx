...
| `firewall-disable`        | raw or persisted `[firewall].mode = "off"` or `"report"` when the approved floor requires stronger lpm.dev firewall verdict checks                   |

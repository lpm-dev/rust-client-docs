...
<figure className="not-prose my-8">
  <div className="rounded-2xl border border-fd-border bg-linear-to-br from-fd-muted via-fd-card to-fd-background p-4 sm:p-8">
    <Image
      src="/images/security-approval-macos.png"
      alt="macOS asks for Touch ID or a password to approve a persistent machine-level security change in LPM CLI."
      width={624}
      height={670}
      sizes="(max-width: 480px) calc(100vw - 66px), 380px"
      className="mx-auto h-auto w-full max-w-[380px] rounded-xl shadow-lg"
    />
  </div>

...
Limits are enforced at the relay (the Cloudflare Worker), not the CLI. Product constants live in [`config/plans.js`](https://github.com/lpm-dev/a-package-manager/blob/main/config/plans.js), and the Worker derives its runtime limit table from [`workers/tunnel/src/limits.js`](https://github.com/lpm-dev/a-package-manager/blob/main/workers/tunnel/src/limits.js).

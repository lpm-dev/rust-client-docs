...
| --- | --- | --- |
| Client → relay | `hello` | Initial handshake — token, requested domain (wire field: `subdomain`), local port |
| Relay → client | `hello` | Handshake response — assigned domain, full `tunnel_url`, `session_id` |

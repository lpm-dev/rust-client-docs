...
| Code                     | Severity  | Description                                                                                                                                                                                                                                               |
| ------------------------ | --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `node_engine_compatible` | pass      | The selected managed Node or current `PATH` Node satisfies `package.json > engines.node`.                                                                                                                                                                |
| `node_engine_mismatch`   | fail/warn | The effective Node violates `package.json > engines.node`. This fails under the default strict policy and warns when engine strictness is disabled. **Fix:** Select a compatible runtime, relax the constraint, or disable strictness in project/user config. |

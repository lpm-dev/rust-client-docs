...
When a connection credential expires, LPM CLI refreshes the saved session and reconnects. Existing HTTP requests and WebSocket connections can close during reconnection.

...
| `:credential-exfiltration` | Send private-key material or the complete process environment in a network payload |
...
| --- | --- |
| Critical | `:obfuscated`, `:protestware`, `:credential-exfiltration` |
...
The local source scanner assigns Critical to high-confidence obfuscation, protestware, and credential exfiltration. Obfuscation uses these confidence bands:

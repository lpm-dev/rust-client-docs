...
| **Triage (Phase 46)** | Tiered automation for the script gate | At install time, per-package |
...
**Provenance drift** (Phase 46 P4) — when a previously-approved package is re-resolved, LPM compares the candidate version's Sigstore provenance against the snapshot captured at approval time:

...
On Windows, sandbox setup preserves existing tool permissions that already allow the required access.
Tool paths that need additional permissions can take longer to prepare.

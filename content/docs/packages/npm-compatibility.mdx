...
| Feature | Where |
| --- | --- |
| Source-qualified trust binding for lifecycle scripts (`name`, `version`, exact source/content identity, `scriptHash`) | [`lpm approve-scripts`](/docs/packages/approve-scripts) |

...
LPM blocks direct/root dependency versions published less than 24h ago by default. npm doesn't. Override with `lpm install --allow-new`. See [Recently published packages](/docs/packages/install#recently-published-packages).

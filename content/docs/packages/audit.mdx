...
Verifies npm registry package signatures for the installed tree. LPM reads `lpm.lock` when present; for non-LPM lockfiles it uses the discovered installed package list and hydrates npm metadata as needed.

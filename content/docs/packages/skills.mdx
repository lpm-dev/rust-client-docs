...
For the conceptual model — what skills are, on-disk layout, editor integration, and the lpm.dev-only status — see [AI agent skills](/docs/reference/ai-agent-skills).

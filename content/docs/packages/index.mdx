...
<Cards>
  ...
  <Card title="lpm quality" href="/docs/packages/quality" description="Quality report for a package." />
</Cards>
...
<Cards>
  ...
  <Card title="lpm patch" href="/docs/packages/patch" description="Local patches with integrity binding (patch-package style)." />
...
<Cards>
  ...
  <Card title="Lockfile" href="/docs/packages/lockfile" description="Dual-format lockfile (lpm.lock TOML + lpm.lockb binary) and the install fast paths." />

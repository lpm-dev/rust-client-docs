...
- **Minimum release age** skips too-new matching candidates for ranges and keeps walking to the newest mature candidate. Exact pins to a too-new version fail.

...
- **Minimum release age** skips too-new matching candidates for direct/root package ranges and keeps walking to the newest mature candidate. Exact direct pins to a too-new version fail.

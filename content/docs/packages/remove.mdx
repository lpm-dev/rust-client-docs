...
3. Removes `.lpm/skills/<owner>.<name>/` if the add installed LPM CLI agent skills, plus any editor integrations LPM CLI set up alongside (for example Cursor symlinks).

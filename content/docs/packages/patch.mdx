...
description: "Create, finalize, and remove local dependency patches with integrity binding."
---
...
On every install, LPM verifies both patch inputs before applying anything:

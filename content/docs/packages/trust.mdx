---
title: lpm trust
description: "Manage project package trust and release-age exclusions."
---
...
For lifecycle scripts, `lpm trust` inspects and cleans `trustedDependencies`. Use [`lpm approve-scripts`](/docs/packages/approve-scripts) to add lifecycle-script approvals.

...
| [`lpm upgrade`](/docs/packages/upgrade)                      | Upgrade `@lpm.dev/*` dependencies to their latest matching range       |
...
| [`lpm search`](/docs/packages/search)                        | Search the lpm.dev registry                                            |
| [`lpm info`](/docs/packages/info)                            | Metadata for an `@lpm.dev/*` package                                   |

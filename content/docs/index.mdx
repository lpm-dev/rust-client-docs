...
- **Compatible.** Reads `package.json`. Resolves npm semver. Materializes `node_modules` (hoisted by default; isolated for workspaces). `lpm install`, `lpm add`, `lpm run` work the way you expect.

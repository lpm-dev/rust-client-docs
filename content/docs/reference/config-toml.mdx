...
| `firewall.npm.policies.lpm_ai_agent_control_surface` | `"allow"` \| `"warn"` \| `"block"` | `"warn"` | User action for LPM AI-agent control-surface policy findings. This is a dangerous-capability policy, not necessarily a malware-intent finding. |

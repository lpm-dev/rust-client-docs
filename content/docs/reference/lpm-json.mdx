...
[`LPM_VAULT_ID`](/docs/reference/env-vars#auth-and-routing) overrides per-invocation. See [Secrets vault — Per-project identity](/docs/infra/secrets-vault#per-project-identity).
